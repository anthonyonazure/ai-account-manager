...
ACCOUNTS_PLAN: list[tuple[Account, list[AccountSnapshot]]] = [
    ...
    (
        _account(
            id="acct-001",
            name="Pinnacle Trust Bank",
            domain="pinnacle-trust.com",
            tier="gold",
            region="NA",
            services=["managed-soc", "vuln-mgmt"],
            months_in=14,
            contract_months=24,
            arr=120_000,
        ...
        [
            _snap(
                "acct-001",
                days_ago=60,
                hubspot_emails_opened_30d=18,
                portal_logins_30d=42,
                hubspot_last_activity_days_ago=2,
            ),
            _snap(
                "acct-001",
                days_ago=30,
                hubspot_emails_opened_30d=10,
                portal_logins_30d=22,
                hubspot_last_activity_days_ago=8,
            ),
            _snap(
                "acct-001",
                days_ago=0,
                hubspot_emails_opened_30d=3,
                portal_logins_30d=6,
                hubspot_last_activity_days_ago=21,
                portal_last_login_days_ago=18,
                sharepoint_doc_views_30d=2,
            ),
        ],
    ),
    ...
    (
        ...
        [
            ...
            _snap(
                "acct-002",
                days_ago=30,
                portal_logins_30d=48,
                portal_modules_active=["soc-dashboard", "vuln-scanner"],
            ),
            _snap(
                "acct-002",
                days_ago=0,
                portal_logins_30d=92,
                portal_modules_active=[
                    "soc-dashboard",
                    "vuln-scanner",
                    "incident-tracker",
                ],
                hubspot_emails_opened_30d=24,
                hubspot_meetings_30d=5,
            ),
        ],
    ),
    ...
    (
        _account(
            id="acct-003",
            name="Arcadia Logistics",
            domain="arcadia-logistics.com",
            tier="silver",
            region="EU",
            services=["managed-soc", "vuln-mgmt"],
            months_in=10,
        ...
        [
            ...
            _snap(
                ...
                hubspot_meetings_30d=4,
                zendesk_tickets_opened_30d=22,
                zendesk_csat=4.8,
            ),
        ],
    ),
    ...
    (
        _account(
            ...
            domain="vanguard-def.com",
            tier="platinum",
            region="NA",
            services=["managed-soc", "incident-response", "vuln-mgmt"],
            months_in=18,
            contract_months=36,
            arr=240_000,
            industry="defense",
        ...
        [
            _snap(
                "acct-004",
                days_ago=30,
                zendesk_p1_count_30d=2,
                zendesk_avg_resolution_hours=14,
                zendesk_csat=4.2,
            ),
            _snap(
                "acct-004",
                days_ago=0,
                zendesk_p1_count_30d=6,
                zendesk_avg_resolution_hours=28,
                zendesk_csat=3.1,
    ...
    (
        _account(
            ...
            domain="meridian-ins.com",
            tier="gold",
            region="NA",
            services=["managed-soc", "compliance"],
            months_in=11,
            contract_months=12,
            arr=96_000,
            industry="insurance",
        ...
        [
            ...
            _snap(
                "acct-005",
                days_ago=0,
                hubspot_meetings_30d=1,
                hubspot_last_activity_days_ago=12,
            ),
        ],
    ),
    ...
    (
        _account(
            ...
            domain="northwind-energy.com",
            tier="gold",
            region="NA",
            services=["managed-soc", "vuln-mgmt", "compliance-reports"],
            months_in=6,
            contract_months=24,
            arr=110_000,
            industry="energy",
        ...
        [
            _snap(
                ...
                days_ago=0,
                portal_modules_active=["soc-dashboard", "vuln-scanner"],
                portal_modules_unused=["compliance-reports"],
                portal_logins_30d=58,
            ),
        ],
    ),
    ...
    (
        _account(
            id="acct-008",
            name="Sentinel Aerospace",
            domain="sentinel-aero.com",
            tier="gold",
            region="NA",
            services=["managed-soc", "vuln-mgmt"],
            months_in=4,
        ...
        [
            _snap(
                "acct-008",
                days_ago=0,
                hubspot_meetings_30d=6,
                hubspot_emails_opened_30d=32,
    ...
    (
        _account(
            id="acct-009",
            name="Coastal Maritime Authority",
            domain="coastal-maritime.gov",
            tier="bronze",
            region="NA",
            services=["managed-soc"],
            months_in=20,
        ...
        [
            _snap(
                "acct-009",
                days_ago=0,
                hubspot_emails_opened_30d=4,
                portal_logins_30d=12,
            )
        ],
    ),
    ...
    (
        _account(
            id="acct-011",
            name="Rivermark Fintech",
            domain="rivermark.io",
            tier="gold",
            region="EU",
            services=["managed-soc", "vuln-mgmt", "incident-response"],
            months_in=15,
            contract_months=24,
            arr=130_000,
            industry="financial_services",
        ...
        [
            _snap(
                "acct-011",
                days_ago=60,
                hubspot_emails_opened_30d=20,
                zendesk_tickets_opened_30d=8,
            ),
            _snap(
                "acct-011",
                days_ago=30,
                hubspot_emails_opened_30d=12,
                zendesk_tickets_opened_30d=18,
            ),
            _snap(
                "acct-011",
                days_ago=0,
                hubspot_emails_opened_30d=4,
                zendesk_tickets_opened_30d=34,
                zendesk_p1_count_30d=3,
                zendesk_csat=3.4,
                hubspot_last_activity_days_ago=14,
            ),
        ],
    ),
    ...
    (
        _account(
            id="acct-012",
            name="Citadel Asset Management",
            domain="citadel-am.com",
            tier="platinum",
            region="NA",
            services=[
                "managed-soc",
        ...
        [
            _snap(
                "acct-012",
                days_ago=0,
                portal_logins_30d=180,
                hubspot_meetings_30d=8,
                zendesk_csat=4.9,
                portal_modules_active=[
                    "soc-dashboard",
                    "vuln-scanner",
